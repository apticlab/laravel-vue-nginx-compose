<template>
  <div
    class="align-middle inline-block min-w-full overflow-hidden sm:rounded-lg bg-white shadow"
    ...
    >
      <thead>
        <tr class="b-y-width-1 b-y-grey-300" :class="theming.header.tr">
          <th
            ...
            class="px-4 py-5 uppercase tracking-wide text-gray-600 font-semibold text-sm"
          >
      ...
      <tbody>
        <tr
          ...
          :key="index"
          :class="index + 1 < rows.length ? 'border-b-gray-100 border-b' : ''"
        >
          <td v-for="(header, index) in headers" :key="index" class="py-6 px-3">
            ...
            >
              ...
              >
                <span class>
                  {{ deepPick(row, header.field) | date | time_ago }}
                </span>
              </div>
              ...
              >
                <span
                  ...
                  :class="
                    deepPick(row, header.field) ? 'bg-green-300' : 'bg-gray-200'
                  "
                ></span>
              </div>
              ...
              >
                <span
                  class="rounded-full h-5 w-5"
                  :class="
                    deepPick(row, header.field) ? 'bg-green-300' : 'bg-red-300'
                  "
                ></span>
              </div>
          ...
          >
            ...
            >
              ...
              >
                <div class="popper shadow-md bg-white rounded py-1 px-2">
                  {{ action.label }}
                </div>
                <button
                  slot="reference"
